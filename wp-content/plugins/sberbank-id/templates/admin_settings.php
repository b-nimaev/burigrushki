      ...
      <tbody>
        ...
        <tr valign="top">
          <th colspan="2" class="titledesc" style="padding-top: 0;">
            <div class="update-nag" style="margin-top:0;">Для получения <b>Client ID</b> и <b>Client secret</b> необходимо заключить договор на Сбербанк ID. Для заключения договора 
