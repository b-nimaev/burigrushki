...
<script src="/wp-content/plugins/sberbank-id/js/sberid-universallink.min.js" type="text/javascript"></script>
<script>
  // $(document).ready(function(){
  //   var loginform = $('#loginform,#front-login-form');
  //   var sberIdlink = $('div.com-sberbankid__block');
  //   loginform.prepend(sberIdlink);
  // });
...
<style>
  ...
  width: 40px;
  height: 40px;
  background-image: url(/wp-content/plugins/sberbank-id/img/sberbank_oauth_logo_1.png);
  background-position: center;
  background-repeat: no-repeat;
  background-size: 24px;
  }
  .sberbank_button.BORDER .sberbank_button-logo {
  background-image: url(/wp-content/plugins/sberbank-id/img/sberbank_oauth_logo_2.png);
  }
